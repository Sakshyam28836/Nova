...
const Features = () => {
  const features = [
    ...
    { name: "Economy", icon: Cash, description: "Virtual economy and currency", color: "text-green-400" },
    ...
    { name: "Statistics", icon: Chart, description: "Detailed server analytics", color: "text-blue-500" },
